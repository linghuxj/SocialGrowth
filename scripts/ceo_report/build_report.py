...
table(['核心事项','年度规划'],[
 ...
 ['首期平台','Facebook、YouTube 双平台验证（Instagram 待稳定后接入），首月 3–5 台真机承载 6–10 个账号；第二月爬坡至 8–10 台真机（16–20 个账号）；第三月约 20 台真机（约 40 个账号）。'],
...
table(['月份','主要交付与业务目标','验收材料'],[
 ['第1月','四周内 3–5 台纯真机承载 FB 与 YouTube 各 3–5 个初始账号（共 6–10 个），跑通策略确认、Artemis 原生 App UI 执行、短链导流和数据反馈真实闭环。','双平台真实发布与执行回执、短链统计数据、独占切片排他流；首期聚焦已有切片。'],
 ['第2月','真机平滑扩展至 8–10 台（承载 FB+YT 共 16–20 个账号），持续运营并对已验证常规账号开放自主托管；验证冷备换号机制。','连续运行、人工干预与异常处理、冷备换号记录、策略调整与效果复盘。'],
 ['第3月','扩展至约 20 台纯真机（FB+YT 共约 40 个账号），形成可验证的 A/B 策略优化闭环与安全回退演练。','候选策略版本记录、对照实验报告、达标全量晋级与不佳策略一键回退依据。'],
